		...
		<div class="container">
			...
			<div class="header-row">
				<div id="site-branding">
					<div class="logoTop"><a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home" itemprop="url"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/mwbroker_logo_top.jpg"></a></div>
...
<?php wp_reset_query(); ?>
					...
					<div class="boxyProdukty"><?php get_sidebar( 'left-half' ); ?></div>
<?php } else { ?>
			
			<?php } ?>						
				</div>
				<div id="secondary-header">
					<div class="boxHasloReklamowe">
					<h1 class="hasloReklamowe"><?php echo get_bloginfo('description'); ?></h1>
					</div>
	<?php
		/**$pagename = get_query_var('pagename');**/
		/**if( ( is_front_page()) ) **/
...
<?php } else { ?>
	...
	<div class="Ozdobnik container-full-width"></div>
