...
<div class="google-map">
	<div id="mapid"></div>
	<!--<div id="mapinfo">Test</div> -->
	<script src="<?php echo get_stylesheet_directory_uri(); ?>/js/mapa.js"></script>
</div>



<footer id="footer" class="site-footer copyright" role="contentinfo" itemscope="itemscope" itemtype="http://schema.org/WPFooter">
<div id="footer-wrapper">
